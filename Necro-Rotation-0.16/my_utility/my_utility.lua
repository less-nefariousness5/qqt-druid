...
local function get_build_settings()
    local menu = require("menu")
    if not menu then
        return {
            aggressive_mode = false,
            elite_priority = true,
            mana_conservation = 0.25,
            selected_build = 0
        }
    end
    
    return {
        aggressive_mode = menu.build_aggressive_mode:get(),
        elite_priority = menu.build_elite_priority:get(), 
        mana_conservation = menu.build_mana_conservation:get(),
        selected_build = menu.build_selector:get()
    }
end
...
return
{
    ...
    get_build_settings = get_build_settings,
