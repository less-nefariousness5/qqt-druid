...
local function logics(target)
    ...
    if is_in_crackling_energy_loop then
        ...
        if debug_enabled then console.print("Sorcerer Plugin, Casted Spear - Crackling Energy Snapshot Complete"); end
    else
        if debug_enabled then console.print("Sorcerer Plugin, Casted Spear"); end
    end
